...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-25 21:19`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/da07f802-38d4-420f-8e40-ddcf5ada2b2a.git
$ cd da07f802-38d4-420f-8e40-ddcf5ada2b2a
```
